...
export class PlaceService {
  ...
  constructor() {
    ...
    this.places = [
      ...
      new Place({
        id: 1,
        name:'Clínica de Psicologia da UFC',
        ...
        location: {
          full_address:'Rua Waldery Uchôa, 3A Benfica',
          zip:'000000-000',
          city:'Fortaleza',
          state:'Ceará',
          latlng: {
      ...
      new Place({
        id: 1,
        name:'Fic',
        description:'A Clínica Escola de Psicologia do Centro Universitário Estácio do Ceará oferece plantão psicológico gratuito, sem necessidade de agendamento prévio. Esta modalidade de atendimento é indicada para pessoas em situações de urgência, que necessitam de auxílio para superar circunstâncias imediatas de crises psicoemocionais. O plantão é recomendado para as pessoas que não estão conseguindo lidar com fatos que estão gerando conflito psíquico naquele momento. Também é indicado para situações que provocam abalo emocional, deixando a pessoa impossibilitada de lidar adequadamente com a problemática. Os psicólogos em formação acolhem de forma incondicional a demanda/queixa que está causando sofrimento à pessoa no momento. Oo objetivo é facilitar a expressão dos sentimentos e emoções desse paciente, contribuindo para a ampliação de sua consciência acerca das possibilidades de lidar da melhor forma possível com os conflitos vivenciados. Além dos plantões, a Clínica Escola de Psicologia da Estácio oferece consultas destinadas a crianças, adolescentes, adultos, idosos, casais e famílias. Dentre os tratamentos, estão a ludoterapia (psicoterapia infantil), orientação profissional, atendimentos individuais e grupais, além de rodas de conversas com grupos da terceira idade.',
        image: 'assets/imgs/default-place-image.png',
        categories:[this.categories.psicossocial],
        tags:[this.tags.pago, this.tags.planounimed, this.tags.aceitacartao],
        location: {
      ...
      new Place({
        ...
        description:'Cuidar da saúde da comunidade por meio de atendimentos simples, ágeis e humanizados, é uma atividade corriqueira na Faculdade Maurício de Nassau. A Clínica Escola de saúde, além de atender pacientes que precisam de cuidados físicos, cuida das questões psicológicas dos que buscam ajuda profissional. Os serviços de psicologia encontrados na instituição são direcionados aos mais diversos perfis; da criança ao adulto idoso, pertencentes a todas as camadas sociais. O atendimento individual, tanto infantil quanto adulto, acontece dentro das perspectivas desejadas pelo conselho de psicologia da região, bem como os atendimentos em grupo que são inteiramente gratuitos. Ao buscar os serviços de psicologia da Clínica Escola da Nassau, o paciente é recebido por um estudante plantonista e encaminhado para triagem, momento em que as queixas são ouvidas e logo em seguida acontece o atendimento solicitado. Serviços da clínica-escola: Plantão Psicológico (Gratuito); Psicoterapia - Abordagens: Psicanalítica, Analítica Junguiana, Gestalt-Terapia, Abordagem Centrada na Pessoa, Terapia Cognitivo Comportamental e Fenomenologia Existencial. (Taxa Social); Orientação Profissional (Gratuito); Psicodiagnóstico (Avaliação Psicológica) - taxa social.',
        image: 'assets/imgs/default-place-image.png',
        categories:[this.categories.psicossocial],
        tags:[this.tags.pago, this.tags.planounimed, this.tags.aceitacartao],
        location: {
